        ...
        <div>
            ...
            <div>
                ...
                <form onSubmit={handleSubmit}>
                    <div>
                        <label>Nome:</label>
                        <input type="text" value={produto.nome} disabled={true} onChange={(e) => setProduto({...produto, nome: e.target.value})}/>
                    </div>
                    <div>
                        <label>Preço:</label>
                        <input type="number" value={produto.preco} disabled={true} onChange={(e) => setProduto({...produto, preco: parseInt(e.target.value)})}/>
                    </div>
                    <div>
